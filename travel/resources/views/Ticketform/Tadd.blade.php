            ...
            <div class="col-12">
                <form method="POST" action="{{route('ticket.store')}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"  id="date_s" aria-describedby="date_s" placeholder="Enter Date Start" name="date_s">
                    </div>
                    <div class="form-group">
                        <label for="date_e">Date End</label>
                        <input type="text"  class="form-control" id="date_e" placeholder=" Enter Date End" name="date_e">
                    </div>
